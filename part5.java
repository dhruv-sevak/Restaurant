...
public class part5 {
    // Employees Method
    public static void getInfoEmployees(String names[], String phoneNumbers[], int yearOfHirings[], String positions[],
            double wages[], int weeks[]) {
        ...
        System.out.println("Experience: " + totalYears1 + " years");
        ...
        System.out.println("Experience: " + totalYears2 + " years");
        ...
        System.out.println("Experience: " + totalYears3 + " years");
    ...
    // Customers Method
    public static void getInfoCustomers(String Names[], String PhoneNumbers[], String orderDayandTimes[],
            String orderTypes[], String onlineOrders[], int ticketNumbers[], int numOfPizzas[], String pizzaTypes[],
            String pizzaSizes[], double pizzaPrices[], String cuttingStyles[], double drinks[], double tips[],
            String allergies[]) {
        Scanner scnr = new Scanner(System.in);
        ...
        System.out.println("Spesial Promotion: Buy 5 PTZZA, Get 1 pizza for FREE!");
        System.out.print("First name: ");
        String FIRSTNAME1 = scnr.nextLine();
    ...
    public static void main(String[] args) {
        ...
        int[] yearOfHirings = new int[100];
        String[] positions = new String[100];
        double[] wages = new double[100];
        int[] weeks = new int[100];

        getInfoEmployees(names, phoneNumbers, yearOfHirings, positions, wages, weeks);

        String Names[] = new String[100];
        String PhoneNumbers[] = new String[100];
        String orderDayandTimes[] = new String[100];
        String orderTypes[] = new String[100];
        String onlineOrders[] = new String[100];
        int ticketNumbers[] = new int[100];
        int numOfPizzas[] = new int[100];
        String pizzaTypes[] = new String[100];
        String pizzaSizes[] = new String[100];
        double pizzaPrices[] = new double[100];
        String cuttingStyles[] = new String[100];
        double drinks[] = new double[100];
        double tips[] = new double[100];
        String allergies[] = new String[100];

        getInfoCustomers(Names, PhoneNumbers, orderDayandTimes, orderTypes, onlineOrders, ticketNumbers, numOfPizzas,
                pizzaTypes, pizzaSizes, pizzaPrices, cuttingStyles, drinks, tips, allergies);
